 ...
 # GNU C (OpenWrt/Linaro GCC 4.8-2014.04 1.4.8.20531s) version 4.8.3 (mipsel-openwrt-linux-uclibc)
 #	compiled by GNU C version 4.4.7 20120313 (Red Hat 4.4.7-17), GMP version 5.1.3, MPFR version 3.1.2, MPC version 1.0.2
 ...
 # -I /home/build/hiwifi/branch/release1.4/B50/14.07/build_dir/target-mipsel_24kec_uClibc-0.9.33.2/linux-mtmips_mt7620/linux-3.10.49/arch/mips/include/uapi
 # -I arch/mips/include/generated/uapi
 # -I /home/build/hiwifi/branch/release1.4/B50/14.07/build_dir/target-mipsel_24kec_uClibc-0.9.33.2/linux-mtmips_mt7620/linux-3.10.49/include/uapi
 # -I include/generated/uapi
 # -I /home/build/hiwifi/branch/release1.4/B50/14.07/build_dir/target-mipsel_24kec_uClibc-0.9.33.2/linux-mtmips_mt7620/linux-3.10.49/arch/mips/include/asm/mach-mtk
 # -I /home/build/hiwifi/branch/release1.4/B50/14.07/build_dir/target-mipsel_24kec_uClibc-0.9.33.2/linux-mtmips_mt7620/linux-3.10.49/arch/mips/include/asm/mach-generic
 # -idirafter /home/build/hiwifi/branch/release1.4/B50/14.07/staging_dir/target-mipsel_24kec_uClibc-0.9.33.2/usr/include
 # -D __KERNEL__ -D VMLINUX_LOAD_ADDRESS=0xffffffff80000000 -D DATAOFFSET=0
 # -D CC_HAVE_ASM_GOTO -D KBUILD_STR(s)=#s
 # -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
 # -D KBUILD_MODNAME=KBUILD_STR(asm_offsets)
 # -isystem /home/build/hiwifi/branch/release1.4/B50/14.07/staging_dir/toolchain-mipsel_24kec_gcc-4.8-linaro_uClibc-0.9.33.2/lib/gcc/mipsel-openwrt-linux-uclibc/4.8.3/include
 # -include /home/build/hiwifi/branch/release1.4/B50/14.07/build_dir/target-mipsel_24kec_uClibc-0.9.33.2/linux-mtmips_mt7620/linux-3.10.49/include/linux/kconfig.h
 # -MD arch/mips/kernel/.asm-offsets.s.d arch/mips/kernel/asm-offsets.c
 # -G 0 -mno-check-zero-division -mabi=32 -mno-abicalls -mno-branch-likely
 # -msoft-float -march=mips32r2 -mllsc -mplt -mno-shared
...
->TASK_MM 168 offsetof(struct task_struct, mm)	 #
 # 0 "" 2
	.loc 1 84 0
 # 84 "arch/mips/kernel/asm-offsets.c" 1
	
->TASK_PID 204 offsetof(struct task_struct, pid)	 #
 # 0 "" 2
	.loc 1 85 0
...
->THREAD_REG16 456 offsetof(struct task_struct, thread.reg16)	 #
 # 0 "" 2
	.loc 1 110 0
 # 110 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG17 460 offsetof(struct task_struct, thread.reg17)	 #
 # 0 "" 2
	.loc 1 111 0
 # 111 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG18 464 offsetof(struct task_struct, thread.reg18)	 #
 # 0 "" 2
	.loc 1 112 0
 # 112 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG19 468 offsetof(struct task_struct, thread.reg19)	 #
 # 0 "" 2
	.loc 1 113 0
 # 113 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG20 472 offsetof(struct task_struct, thread.reg20)	 #
 # 0 "" 2
	.loc 1 114 0
 # 114 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG21 476 offsetof(struct task_struct, thread.reg21)	 #
 # 0 "" 2
	.loc 1 115 0
 # 115 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG22 480 offsetof(struct task_struct, thread.reg22)	 #
 # 0 "" 2
	.loc 1 116 0
 # 116 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG23 484 offsetof(struct task_struct, thread.reg23)	 #
 # 0 "" 2
	.loc 1 117 0
 # 117 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG29 488 offsetof(struct task_struct, thread.reg29)	 #
 # 0 "" 2
	.loc 1 118 0
 # 118 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG30 492 offsetof(struct task_struct, thread.reg30)	 #
 # 0 "" 2
	.loc 1 119 0
 # 119 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG31 496 offsetof(struct task_struct, thread.reg31)	 #
 # 0 "" 2
	.loc 1 120 0
 # 120 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_STATUS 500 offsetof(struct task_struct, thread.cp0_status)	 #
 # 0 "" 2
	.loc 1 122 0
 # 122 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPU 504 offsetof(struct task_struct, thread.fpu)	 #
 # 0 "" 2
	.loc 1 124 0
 # 124 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_BVADDR 820 offsetof(struct task_struct, thread.cp0_badvaddr)	 #
 # 0 "" 2
	.loc 1 126 0
 # 126 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_BUADDR 824 offsetof(struct task_struct, thread.cp0_baduaddr)	 #
 # 0 "" 2
	.loc 1 128 0
 # 128 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_ECODE 828 offsetof(struct task_struct, thread.error_code)	 #
 # 0 "" 2
	.loc 1 130 0
...
->THREAD_FPR0 504 offsetof(struct task_struct, thread.fpu.fpr[0])	 #
 # 0 "" 2
	.loc 1 136 0
 # 136 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR1 512 offsetof(struct task_struct, thread.fpu.fpr[1])	 #
 # 0 "" 2
	.loc 1 137 0
 # 137 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR2 520 offsetof(struct task_struct, thread.fpu.fpr[2])	 #
 # 0 "" 2
	.loc 1 138 0
 # 138 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR3 528 offsetof(struct task_struct, thread.fpu.fpr[3])	 #
 # 0 "" 2
	.loc 1 139 0
 # 139 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR4 536 offsetof(struct task_struct, thread.fpu.fpr[4])	 #
 # 0 "" 2
	.loc 1 140 0
 # 140 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR5 544 offsetof(struct task_struct, thread.fpu.fpr[5])	 #
 # 0 "" 2
	.loc 1 141 0
 # 141 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR6 552 offsetof(struct task_struct, thread.fpu.fpr[6])	 #
 # 0 "" 2
	.loc 1 142 0
 # 142 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR7 560 offsetof(struct task_struct, thread.fpu.fpr[7])	 #
 # 0 "" 2
	.loc 1 143 0
 # 143 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR8 568 offsetof(struct task_struct, thread.fpu.fpr[8])	 #
 # 0 "" 2
	.loc 1 144 0
 # 144 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR9 576 offsetof(struct task_struct, thread.fpu.fpr[9])	 #
 # 0 "" 2
	.loc 1 145 0
 # 145 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR10 584 offsetof(struct task_struct, thread.fpu.fpr[10])	 #
 # 0 "" 2
	.loc 1 146 0
 # 146 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR11 592 offsetof(struct task_struct, thread.fpu.fpr[11])	 #
 # 0 "" 2
	.loc 1 147 0
 # 147 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR12 600 offsetof(struct task_struct, thread.fpu.fpr[12])	 #
 # 0 "" 2
	.loc 1 148 0
 # 148 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR13 608 offsetof(struct task_struct, thread.fpu.fpr[13])	 #
 # 0 "" 2
	.loc 1 149 0
 # 149 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR14 616 offsetof(struct task_struct, thread.fpu.fpr[14])	 #
 # 0 "" 2
	.loc 1 150 0
 # 150 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR15 624 offsetof(struct task_struct, thread.fpu.fpr[15])	 #
 # 0 "" 2
	.loc 1 151 0
 # 151 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR16 632 offsetof(struct task_struct, thread.fpu.fpr[16])	 #
 # 0 "" 2
	.loc 1 152 0
 # 152 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR17 640 offsetof(struct task_struct, thread.fpu.fpr[17])	 #
 # 0 "" 2
	.loc 1 153 0
 # 153 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR18 648 offsetof(struct task_struct, thread.fpu.fpr[18])	 #
 # 0 "" 2
	.loc 1 154 0
 # 154 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR19 656 offsetof(struct task_struct, thread.fpu.fpr[19])	 #
 # 0 "" 2
	.loc 1 155 0
 # 155 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR20 664 offsetof(struct task_struct, thread.fpu.fpr[20])	 #
 # 0 "" 2
	.loc 1 156 0
 # 156 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR21 672 offsetof(struct task_struct, thread.fpu.fpr[21])	 #
 # 0 "" 2
	.loc 1 157 0
 # 157 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR22 680 offsetof(struct task_struct, thread.fpu.fpr[22])	 #
 # 0 "" 2
	.loc 1 158 0
 # 158 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR23 688 offsetof(struct task_struct, thread.fpu.fpr[23])	 #
 # 0 "" 2
	.loc 1 159 0
 # 159 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR24 696 offsetof(struct task_struct, thread.fpu.fpr[24])	 #
 # 0 "" 2
	.loc 1 160 0
 # 160 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR25 704 offsetof(struct task_struct, thread.fpu.fpr[25])	 #
 # 0 "" 2
	.loc 1 161 0
 # 161 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR26 712 offsetof(struct task_struct, thread.fpu.fpr[26])	 #
 # 0 "" 2
	.loc 1 162 0
 # 162 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR27 720 offsetof(struct task_struct, thread.fpu.fpr[27])	 #
 # 0 "" 2
	.loc 1 163 0
 # 163 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR28 728 offsetof(struct task_struct, thread.fpu.fpr[28])	 #
 # 0 "" 2
	.loc 1 164 0
 # 164 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR29 736 offsetof(struct task_struct, thread.fpu.fpr[29])	 #
 # 0 "" 2
	.loc 1 165 0
 # 165 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR30 744 offsetof(struct task_struct, thread.fpu.fpr[30])	 #
 # 0 "" 2
	.loc 1 166 0
 # 166 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR31 752 offsetof(struct task_struct, thread.fpu.fpr[31])	 #
 # 0 "" 2
	.loc 1 168 0
 # 168 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FCR31 760 offsetof(struct task_struct, thread.fpu.fcr31)	 #
 # 0 "" 2
	.loc 1 169 0
...
->VCPU_ARCH_SIZE 3344 sizeof(struct kvm_vcpu_arch)	 #
 # 0 "" 2
	.loc 1 338 0
...
$Letext0:
	...
	.file 4 "/home/build/hiwifi/branch/release1.4/B50/14.07/build_dir/target-mipsel_24kec_uClibc-0.9.33.2/linux-mtmips_mt7620/linux-3.10.49/arch/mips/include/asm/page.h"
	.file 5 "/home/build/hiwifi/branch/release1.4/B50/14.07/build_dir/target-mipsel_24kec_uClibc-0.9.33.2/linux-mtmips_mt7620/linux-3.10.49/arch/mips/include/asm/cpu-info.h"
	.file 6 "include/linux/printk.h"
	.file 7 "include/linux/kernel.h"
	.file 8 "include/linux/cpumask.h"
	.file 9 "include/linux/time.h"
	.file 10 "/home/build/hiwifi/branch/release1.4/B50/14.07/build_dir/target-mipsel_24kec_uClibc-0.9.33.2/linux-mtmips_mt7620/linux-3.10.49/arch/mips/include/asm/io.h"
	...
	.file 19 "/home/build/hiwifi/branch/release1.4/B50/14.07/build_dir/target-mipsel_24kec_uClibc-0.9.33.2/linux-mtmips_mt7620/linux-3.10.49/arch/mips/include/asm/pgtable-32.h"
	.file 20 "/home/build/hiwifi/branch/release1.4/B50/14.07/build_dir/target-mipsel_24kec_uClibc-0.9.33.2/linux-mtmips_mt7620/linux-3.10.49/arch/mips/include/asm/pgtable.h"
	...
	.file 25 "include/linux/cgroup_subsys.h"
	.file 26 "include/linux/memcontrol.h"
	.file 27 "include/linux/ioport.h"
...
$LASF75:
	.ascii	"/home/build/hiwifi/branch/release1.4/B50/14.07/build_dir"
	.ascii	"/target-mipsel_24kec_uClibc-0.9.33.2/linux-mtmips_mt7620"
	.ascii	"/linux-3.10.49\000"
$LASF44:
...
$LASF12:
	.ascii	"atomic_t\000"
	.ident	"GCC: (OpenWrt/Linaro GCC 4.8-2014.04 1.4.8.20531s) 4.8.3"
