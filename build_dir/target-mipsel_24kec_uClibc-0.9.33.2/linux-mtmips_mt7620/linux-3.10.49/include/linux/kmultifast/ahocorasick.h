...
typedef AC_AUTOMATA_t* PAC_AUTOMATA_t;

AC_STATUS_t 	ac_automata_init (PAC_AUTOMATA_t* pac);
AC_STATUS_t     ac_automata_add      (AC_AUTOMATA_t * thiz, AC_PATTERN_t * str);
AC_STATUS_t     ac_automata_add_reverse (AC_AUTOMATA_t * thiz, AC_PATTERN_t * str);
AC_STATUS_t 	ac_automata_finalize (AC_AUTOMATA_t * thiz);
AC_STATUS_t 	ac_automata_settext (AC_AUTOMATA_t * thiz, AC_TEXT_t * text, int keep);
AC_STATUS_t 	ac_automata_settext_reverse (AC_AUTOMATA_t * thiz,AC_TEXT_t * text,int keep);
AC_STATUS_t     ac_automata_findnext (AC_AUTOMATA_t * thiz, AC_MATCH_t* pmatch);
AC_STATUS_t     ac_automata_findnext_reverse (AC_AUTOMATA_t * thiz,AC_MATCH_t * pmatch);
