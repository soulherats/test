...
static inline void __nf_copy(struct sk_buff *dst, const struct sk_buff *src)
{
	...
	if((dst->imq_flags&IMQ_F_ENQUEUE)&&dst->nf_queue_entry)
		dst->nf_queue_entry->skb=dst;
#endif
#ifdef CONFIG_BRIDGE_NETFILTER
...
/*Support for HNAT*/
#define HNAT_MASK_LEN 17 

extern void skb_no_accelerate(struct sk_buff *skb);
extern void skb_accelerate(struct sk_buff *skb);
extern int skb_is_accelerate(struct sk_buff *skb);
#endif	/* __KERNEL__ */
