...
define Image/BuildKernel/MkFIT
	...
	PATH=$(LINUX_DIR)/scripts/dtc:$(PATH) $(STAGING_DIR_HOST)/bin/mkimage -f $(KDIR)/fit-$(1).its $(KDIR)/fit-$(1)$(7).itb
endef
...
define Image/BuildKernel/MkFITMulti
	...
	PATH=$(LINUX_DIR)/scripts/dtc:$(PATH) $(STAGING_DIR_HOST)/bin/mkimage -f $(KDIR)/fit-$(1).its $(KDIR)/fit-$(1).itb
endef
