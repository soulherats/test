...
KERNEL_MAKEOPTS := -C $(LINUX_DIR) \
	HOSTCFLAGS="$(HOST_CFLAGS) -Wall -Wmissing-prototypes -Wstrict-prototypes -Wno-unused-local-typedefs" \
...
ifeq ($(strip $(CONFIG_HIWIFI_KERNEL_TREE)),"")
ifeq ($(strip $(CONFIG_EXTERNAL_KERNEL_TREE)),"")
  ...
  define Kernel/Prepare/Default
	...
	mkdir $(LINUX_DIR)
	cp -rf $(TOPDIR)/$(CONFIG_HIWIFI_KERNEL_TREE)/$(LINUX_VERSION)/* $(LINUX_DIR)
  endef
endif
...
define Kernel/CopyImage
	# copy vmlinux for debug and strip debug info for rom
	cp -rf $(LINUX_DIR)/vmlinux $(LINUX_DIR)/vmlinux-debug
	$(KERNEL_CROSS)strip -g -S -d --strip-debug $(LINUX_DIR)/vmlinux
