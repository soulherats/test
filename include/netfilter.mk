...
$(eval $(call nf_add,IPT_CORE,CONFIG_NETFILTER_XT_MATCH_ID, $(P_XT)xt_id, ge 3.4.0))
...
# hiwifi smart qos mark
$(eval $(if $(NF_KMOD),,$(call nf_add,IPT_IPOPT,CONFIG_NETFILTER_XT_MARK, $(P_XT)xt_QOSMARK)))
...
#ProStat
$(eval $(call nf_add,IPT_PROSTAT,CONFIG_NETFILTER_XT_TARGET_PROSTAT, $(P_XT)xt_PROSTAT))
