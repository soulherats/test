...
#define __GMP_CFLAGS "-Os -pipe -g -mno-branch-likely -mips32r2 -mtune=24kec -fno-caller-saves -fhonour-copts -Wno-error=unused-but-set-variable -msoft-float -fpic "
